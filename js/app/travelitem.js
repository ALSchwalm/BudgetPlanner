...
define(["jquery"], function(jquery){
     ...
     */
    var TravelItem = function(elem, widget, start, end, config) {
        this.parent = widget;
        this.start = start;
        this.end = end;
        this.body = $("<div>")
            .load("bodies/travelitem.html",
                  null,
                  function(){
                      this.init();
     ...
     */
    TravelItem.prototype.save = function() {
        return {
     ...
     */
    TravelItem.prototype.restore = function(config) {
    ...
    TravelItem.prototype.update = function() {
    }
     ...
     */
    TravelItem.prototype.updateDuration = function(start, end) {
        this.start = start;
        this.end = end;
     ...
     */
    TravelItem.prototype.addYear = function() {
     ...
     */
    TravelItem.prototype.removeYear = function() {
     ...
     */
    TravelItem.prototype.val = function() {
        var arr = [];
     ...
     */
    TravelItem.prototype.serialize = function() {
